...
export async function getCurrentUserWithFlights() {
  ...
  try {
    ...
    console.error("Database connection error in getCurrentUserWithFlights:", error);
    return null;
  }
}
...
export async function getCurrentUserWithAircraft() {
  ...
  try {
    ...
    console.error("Database connection error in getCurrentUserWithAircraft:", error);
    return null;
  }
}
...
export async function getCurrentUserFull() {
  ...
  try {
    ...
    console.error("Database connection error in getCurrentUserFull:", error);
    return null;
  }
}
