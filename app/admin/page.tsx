        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            ...
            <div className="flex gap-2 mb-6 overflow-x-auto pb-2 -mx-2 px-2">
              <button
                className={`px-4 py-2 rounded-lg text-sm font-medium border cursor-pointer transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 whitespace-nowrap
                  ${activeTab === 'overview'
          ...
          {activeTab === 'verifications' && (
            <section aria-label="Verifications">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                          ...
                          <div className="flex items-center gap-2 sm:shrink-0">
                            ...
                            >
                              ...
                              <span className="hidden sm:inline">Verify as Pilot</span>
              ...
              {verifiedPilots.length > 0 && (
                <div>
                  <h2 className="text-xl font-semibold text-foreground mb-4">Recently Verified Pilots</h2>
                  <div className="space-y-3">
                    {verifiedPilots.slice(0, 5).map((user) => (
                      <Card key={user.id} className="p-4">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                          <div className="flex-1">
                            <div className="flex items-center gap-3">
