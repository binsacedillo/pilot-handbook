        ...
        <div className="w-full max-w-md flex flex-col items-center">
          ...
          <Link href="/" className="flex flex-col items-center gap-4 mb-10 group transition-all duration-300">
            ...
            <div className="text-center">
              ...
              <p className="text-[10px] font-bold text-zinc-500 tracking-[.3em] uppercase mt-1">Personnel Registration</p>
            </div>
          </Link>
          ...
          <SignUp
            ...
            appearance={{
              ...
              elements: {
                ...
                formFieldInput: "bg-zinc-950 border-zinc-800 text-white h-12 focus:border-blue-500 transition-all text-sm",
