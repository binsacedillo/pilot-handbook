...
**Location:** `components/dev/DevWarningBanner.tsx`  
...
**Location:** `components/dev/DevBadge.tsx`
...
Edit `components/dev/DevWarningBanner.tsx`:
```tsx
...
Remove the X button and dismiss logic from `components/dev/DevWarningBanner.tsx`
